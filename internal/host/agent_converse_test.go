...
// TestAgentConverse_MissingQuestion returns Result.Error, not a Go error.
func TestAgentConverse_MissingQuestion(t *testing.T) {
	t.Parallel()
...
// TestAgentConverse_InvalidPermissionMode returns Result.Error.
func TestAgentConverse_InvalidPermissionMode(t *testing.T) {
	t.Parallel()
	res, err := host.AgentConverseHandler(context.Background(), map[string]any{
		"question":        "hello",
...
// TestAgentConverse_DefaultPermissionMode verifies that omitting permission_mode
// defaults to bypassPermissions — matches legacy talk behaviour.
func TestAgentConverse_DefaultPermissionMode(t *testing.T) {
	t.Parallel()
...
// TestAgentConverse_PermissionModeAsk verifies permission_mode: ask is
// translated to the CLI-valid enforcing mode (claude rejects "ask" verbatim).
func TestAgentConverse_PermissionModeAsk(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), stubConverseRunner())
...
// TestAgentConverse_PermissionModeDenyAll verifies permission_mode: denyAll is
// translated to the enforcing mode plus a hard --disallowedTools deny of every
// mutating tool (claude rejects "denyAll" verbatim).
func TestAgentConverse_PermissionModeDenyAll(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), stubConverseRunner())
...
// TestAgentConverse_GeneratesSessionID verifies that omitting session_id causes
// the handler to mint a v4 UUID and return it.
func TestAgentConverse_GeneratesSessionID(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), stubConverseRunner())
...
// TestAgentConverse_AnswerPresent verifies the answer field is populated.
func TestAgentConverse_AnswerPresent(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), stubConverseRunner())
...
// TestAgentConverse_AgentSystemPromptAndModel verifies agent: resolves and
// forwards SystemPrompt + Model to claude.
func TestAgentConverse_AgentSystemPromptAndModel(t *testing.T) {
	t.Parallel()
...
// TestAgentConverse_AgentTools_ForwardedAsAllowedTools verifies that agent.Tools
// is forwarded as --allowedTools.
func TestAgentConverse_AgentTools_ForwardedAsAllowedTools(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(
		host.WithAgents(context.Background(), map[string]host.Agent{
...
// TestAgentConverse_ChatStore_FirstTurn verifies that on the first turn:
...
func TestAgentConverse_ChatStore_FirstTurn(t *testing.T) {
	t.Parallel()
	cs := newFakeChatStore()
...
// TestAgentConverse_ChatStore_ReusesSessionID verifies that a second turn
// reuses the existing claude_session_id via --resume.
func TestAgentConverse_ChatStore_ReusesSessionID(t *testing.T) {
	t.Parallel()
...
// TestAgentConverse_ChatStore_NoChatStore returns a domain error when
// chat_id is set but no ChatStore is wired.
func TestAgentConverse_ChatStore_NoChatStore(t *testing.T) {
	t.Parallel()
	res, err := host.AgentConverseHandler(context.Background(), map[string]any{
		"question": "anything",
		"chat_id":  "some-chat",
...
// TestAgentConverse_ChatStore_PermissionModeForwarded verifies that
// permission_mode is forwarded on the chat-aware path too.
func TestAgentConverse_ChatStore_PermissionModeForwarded(t *testing.T) {
	t.Parallel()
	cs := newFakeChatStore()
...
// TestAgentConverse_RegisteredAsBuiltin verifies AgentConverseHandler is
// wired into the registry by RegisterBuiltins.
func TestAgentConverse_RegisteredAsBuiltin(t *testing.T) {
	t.Parallel()
	r := host.NewRegistry()
	host.RegisterBuiltins(r)
	if _, ok := r.Get("host.agent.converse"); !ok {
		t.Fatal("host.agent.converse was not registered by RegisterBuiltins")
	}
}

// TestAgentTalk_RemovedAsBuiltin verifies the deprecated alias is no longer
// registered after Phase 9 alias removal.
func TestAgentTalk_RemovedAsBuiltin(t *testing.T) {
	t.Parallel()
	r := host.NewRegistry()
	host.RegisterBuiltins(r)
	if _, ok := r.Get("host.agent.talk"); ok {
		t.Fatal("host.agent.talk should have been removed in Phase 9 but is still registered")
	}
}

// ── Binary missing ────────────────────────────────────────────────────────────

// TestAgentConverse_BinaryMissing returns Result.Error with a helpful message.
func TestAgentConverse_BinaryMissing(t *testing.T) {
