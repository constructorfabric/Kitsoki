...
export const WEB_INBOX_TOUR_STEPS: readonly TourStep[] = [
  ...
  },
  {
    ...
    body: "Even after the toast fades the count persists on the global inbox badge — fixed in the chrome, visible on every route. When the background job reached a terminal state the runtime posted a notification, the server fanned it out over the global notifications SSE stream, and this badge incremented. The same badge also counts active work such as queued subagents, while attention color is reserved for work that needs intervention.",
    placement: "left",
    kind: "explain",
    advance: "next",
