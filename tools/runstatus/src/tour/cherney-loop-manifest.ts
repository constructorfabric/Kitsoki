...
export const CHERNEY_LOOP_TOUR_STEPS: readonly TourStep[] = [
  ...
  },
  {
    id: "cl-begin",
    route: "any",
    target: "intent-btn-begin",
    waitForTarget: "intent-btn-begin",
    title: "Begin a loop",
    body: "We start parked at idle. Begin opens configuration, where you state the goal, the gate that proves it, and the budgets.",
    placement: "bottom",
    kind: "explain",
    advance: "next",
    dwellMs: 4500,
  },
  {
    ...
    body: "We configure a goal (make the unit tests pass), a script gate (a command that passes only on exit 0 — the checker is code, it can't be talked into passing), and a small iteration budget of 4.",
    placement: "bottom",
    kind: "explain",
    advance: "next",
    dwellMs: 6000,
