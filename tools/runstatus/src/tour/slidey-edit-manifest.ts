...
export const SLIDEY_EDIT_TOUR_STEPS: readonly TourStep[] = [
  ...
  // ── Refine from the anchor ──────────────────────────────────────────────────
  {
    ...
    body: "Now refine. The reviser receives the location-tied anchor and edits the scene element behind it — never a guess at what you meant. The run returns to reviewing with the deck re-rendered, ready for another pass. Annotate → refine, closed loop.",
    placement: "bottom",
    kind: "explain",
    advance: "next",
