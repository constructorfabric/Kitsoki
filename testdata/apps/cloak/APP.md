...
**Version** 0.1.0 · _by Roger Firth (spec), ported to Hally_ · License: Spec in public domain; this port CC0
...
_Generated from `app.yaml` by `hally render`. Do not edit this file directly — edit `app.yaml` and re-run `hally render`. See `hally docs apply-proposal` for the LLM-driven proposal workflow._
