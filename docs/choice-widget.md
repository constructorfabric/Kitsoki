...
view:
  - choice: { ... }
  # (extends/elements coexistence is not implemented yet — workaround:
  # keep `extends:` on the wrapping view and place `choice:` as a
  # sibling element rather than nesting it inside a block.)
```
