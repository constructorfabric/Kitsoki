...
> [providers](./providers.md) (which retarget the `claude` CLI's
> endpoint) and to [agent plugins](../../architecture/agent-plugin.md) (which choose which
> component answers).
...
> [`agent_launch_policy:`](./launch-policy.md) confining launches to opened
