...
3. Document the input/output contract in the handler's Go doc comment
   *and* in [`hosts.md`](../../architecture/hosts.md). The contract is part of the public
...
[`mcp-studio.md`](../../architecture/mcp-studio.md).
...
- **One responsibility per package.** The package map in
  [`architecture.md`](../../architecture/overview.md#3-package-map) is the contract.
...
- **Architecture overview** → [`architecture.md`](../../architecture/overview.md)
...
- **Hosts and transports** → [`hosts.md`](../../architecture/hosts.md), [`transports.md`](../../architecture/transports.md)
...
- **Prior art and comparative grounding** → [`prior-art.md`](../../architecture/prior-art.md)
